...
api.get_representatives.each do |rep|
  rep_node = @neo.create_node(:person_id => rep.person_id, :member_id => rep.member_id, :full_name => rep.full_name, :party => rep.party, :image_url => image_root + rep.image_url, :electorate => rep.constituency)
  ...
  @neo.add_node_to_index :representatives, :electorate, rep.constituency, rep_node
end